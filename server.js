...
if(!fs.existsSync(dbFile))fs.writeFileSync(dbFile,JSON.stringify(defaults,null,2),"utf8");
...
app.post("/api/alerts",(q,s)=>{
  try{
    ...
    saveAlert(a);return s.status(201).json(a);
...
app.listen(PORT,"0.0.0.0",()=>console.log("CareGesture AI running on port "+PORT));