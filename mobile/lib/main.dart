...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> speakAlert(dynamic x) async {
    ...
    try {
      ...
      final roomWord = x['language'] == 'kn' ? 'ಕೊಠಡಿ' : x['language'] == 'hi' ? 'कमरा' : 'Room';
      final bedWord = x['language'] == 'kn' ? 'ಹಾಸಿಗೆ' : x['language'] == 'hi' ? 'बिस्तर' : 'Bed';
      await tts.awaitSpeakCompletion(true);
      await tts.speak('${x['message']}. $roomWord ${x['room']}. $bedWord ${x['bed']}');
    } catch (_) {}
  }
