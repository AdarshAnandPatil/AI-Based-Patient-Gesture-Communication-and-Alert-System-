...
This version keeps alerts in memory even if a temporary filesystem write fails, so the live alert API continues working. For permanent persistence across Render restarts/redeploys, connect a persistent database such as PostgreSQL.
