(() => {
  ...
  /* =========================================================
     LANGUAGE DATA
     ENGLISH KEPT WORKING AS BEFORE
     ========================================================= */
  ...
  /* =========================================================
     VOICE - IMPROVED FOR ENGLISH, KANNADA, HINDI
     ========================================================= */
  ...
  /*
     Find the best voice for selected language.

     Priority:
     1. Exact language (hi-IN / kn-IN)
     2. Same language family (hi / kn)
     3. Voice name contains language name
  */
  ...
  /*
     Creates the COMPLETE voice sentence.

     IMPORTANT:
     English remains English.

     Kannada:
     "ಆಹಾರ ಬೇಕು. ಕೊಠಡಿ ಸಂಖ್ಯೆ 204. ಹಾಸಿಗೆ ಸಂಖ್ಯೆ 3."

     Hindi:
     "खाना चाहिए। कमरा नंबर 204। बिस्तर नंबर 3।"
  */

  function createVoiceText(alert) {
    ...
    /* ENGLISH - KEEP SAME WORKING STYLE */
  ...
  function speak(text, language = null) {
    ...
    try {
      ...
      /*
         IMPORTANT:
         Load voices immediately before speaking.
      */
      ...
      */
      ...
      /*
         Select Kannada / Hindi / English voice.
      */
      ...
      */
      ...
      /*
         ...
         Resume if browser pauses speech.
      */
        ...
        (state.reports || [])
          .map(report => `
            ...
            <div class="alert-card">
              ...
              <b>
                📄
                ${escapeHTML(report.originalName)}
              </b>
  ...
  function overlay(alert) {
    ...
    /*
       ...
       Use complete language-specific
       voice sentence.
    */

    const voiceText =
      createVoiceText(alert);
  ...
  async function createAlert(
    ...
    try {
      ...
      if (!message) {
        throw new Error("Invalid gesture");
      }
  ...
  function processGesture(fingerCount) {
    ...
    const gesture =
      FINGER_GESTURES[fingerCount];

    if (!gesture) return;


    if (
      candidateGesture !== fingerCount
    ) {
    ...
    if (
      lastDetectedGesture === fingerCount
    ) {
      return;
    }
  ...
  async function handleDetectedGesture(
    ...
    if (
      ...
      lastAlertGesture === fingerCount

      &&

      now - lastAlertTime < 3500
  ...
  function setupEvents() {
    ...
    /*
       ...
       FIX:
       Uses complete Kannada/Hindi/English
       sentence.
    */
