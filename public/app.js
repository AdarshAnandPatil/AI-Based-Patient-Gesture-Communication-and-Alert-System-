(() => {
  ...
  /*
     Creates correct speech text for every language.
  */

  function createVoiceMessage(alert) {
  ...
  function overlay(alert) {
    ...
    /*
       IMPORTANT:
       Create complete voice message
       according to selected language.
    */

    const voiceText =
      createVoiceMessage(alert);


    console.log(
      "Automatic alert voice:",
      voiceText
    );
    ...
    */
    ...
    if (action === "voice") {
      ...
      if (alert) {
        ...
        /*
           Correct language voice message.
        */
    ...
    */
    ...
    if ($("detectedDetail")) {
      ...
      $("detectedDetail").textContent =
        "Patient gesture detected successfully.";
      ...
      */
      ...
      if ($("cameraDiagnostic")) {
        ...
        $("cameraDiagnostic").textContent =
          "AI ready. Camera connected. Show one hand clearly.";
